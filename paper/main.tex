...
\toprule
& \cellcolor{ebbluepale}\textcolor{ebblue}{\textbf{Blinded (Gene\_088, ranked \#5)}} & \cellcolor{eborangepale}\textcolor{eborange}{\textbf{Unblinded (KRAS, ranked \#1)}} \\
\midrule
...
\addlinespace
\textbf{Additional reasoning} & ``GTPase domain concentrated mutations suggest gain-of-function mechanism'' & \cellcolor{ebcontamination}\textcolor{ebcoral}{\textbf{``Proven therapeutic tractability via covalent RAS inhibitors (sotorasib, adagrasib)''}} \newline \cellcolor{ebcontamination}\textcolor{ebcoral}{\textbf{``Central node in RAS/MAPK pathway with extensive clinical validation''}} \\
\addlinespace
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.6\textwidth]{figures/fig3_slope_chart.png}
